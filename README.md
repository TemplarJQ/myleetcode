...
又是发周报的日子，和学长说的13号考完试，还有一门课的时间，周一应该就要开始干活了，趁今天还有时间，提前看一下项目的内容，怎么说也是一个系统化的python项目，能学到一点是一点\
...
组里刘富牛学长和许金良学长还吵了一架，这肯定不是最后一次吧，西八，真的是破事越来越多了呢，希望自己能顺顺利利毕业，唉。\
明天还要考分布式，今天刷三道简单的算了。结果一上来740又是个DP题目，难受，肯定要找个机会做会DP题目。\
...
后天就考图论了，题量就下降了，今天就做了一道506题目，这个题是map综合了排序的算法，感觉还挺有意思的，估计可以用优先队列解除\
